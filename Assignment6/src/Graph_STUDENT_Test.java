...
public class Graph_STUDENT_Test {
	...
	public void testContainsVertex() {
		assertEquals(true, graph.containsVertex(new Town("Town2")));
		assertEquals(false, graph.containsVertex(new Town("Town12")));
	}
	 ...
	 @Test
	  public void testTown_1ToTown_11() {
		  ...
		  if(beginIndex != null && endIndex != null)
		  {
			  ...
			  assertEquals("Town1 via Road_1 to Town2 2 mi",path.get(0).trim());
			  assertEquals("Town2 via Road_12 to Town11 6 mi",path.get(1).trim());
		  }
		  else
